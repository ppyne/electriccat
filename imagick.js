...
function is_ready() { if (window !== undefined) { const event = new Event('IMReady'); window.dispatchEvent(event); } }
function console_log(str) { console.log(UTF8ToString(str)); }
function console_error(str1,str2) { console.error(UTF8ToString(str1) + UTF8ToString(str2)); }
function console_error_wand(str1,str2,n,str3) { console.error(UTF8ToString(str1) + ' ' + UTF8ToString(str2) + ' line ' + n + ' ' + UTF8ToString(str3)); }
function console_log_quadruplet(i,r,g,b,a) { let _r = r.toString(16); if (_r.length < 2) _r = '0' + _r; let _g = g.toString(16); if (_g.length < 2) _g = '0' + _g; let _b = b.toString(16); if (_b.length < 2) _b = '0' + _b; let _a = a.toString(16); if (_a.length < 2) _a = '0' + _a; console.log(i, _r, _g, _b, _a); }
function console_log_color(i,r,g,b) { let _r = r.toString(16); if (_r.length < 2) _r = '0' + _r; let _g = g.toString(16); if (_g.length < 2) _g = '0' + _g; let _b = b.toString(16); if (_b.length < 2) _b = '0' + _b; console.log(i, '#' + _r + _g + _b); }
function console_log_len(len) { console.log('len', len); }
  ...
  try {
      ...
      var len = convertI32PairToI53Checked(len_low, len_high); if (isNaN(len)) return -61;
...
var asmLibraryArg = {
  ...
  "console_error_wand": console_error_wand,
  "console_log": console_log,
  "console_log_color": console_log_color,
  "console_log_len": console_log_len,
  "console_log_quadruplet": console_log_quadruplet,
...
/** @type {function(...*):?} */
var __IMCharcoal = Module["__IMCharcoal"] = createExportWrapper("_IMCharcoal");

/** @type {function(...*):?} */
var __IMSketch = Module["__IMSketch"] = createExportWrapper("_IMSketch");
...
/** @type {function(...*):?} */
var __IMQuantizeAndListUniqueColors = Module["__IMQuantizeAndListUniqueColors"] = createExportWrapper("_IMQuantizeAndListUniqueColors");
...
/** @type {function(...*):?} */
var __IMMorphology = Module["__IMMorphology"] = createExportWrapper("_IMMorphology");
...
/** @type {function(...*):?} */
var __IMSoftLight = Module["__IMSoftLight"] = createExportWrapper("_IMSoftLight");
...
/** @type {function(...*):?} */
var __IMCmdAutoGamma = Module["__IMCmdAutoGamma"] = createExportWrapper("_IMCmdAutoGamma");
...
/** @type {function(...*):?} */
var __IMTurbulence = Module["__IMTurbulence"] = createExportWrapper("_IMTurbulence");

/** @type {function(...*):?} */
var __IMToWebP = Module["__IMToWebP"] = createExportWrapper("_IMToWebP");
...
var ___start_em_js = Module['___start_em_js'] = 607664;
var ___stop_em_js = Module['___stop_em_js'] = 608832;
